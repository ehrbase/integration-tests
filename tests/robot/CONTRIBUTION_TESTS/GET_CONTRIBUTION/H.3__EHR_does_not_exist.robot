...
...
...     Flow:
...         1. Invoke get CONTRIBUTION service by a random ehr_id and a random CONTRIBUTION uid
...         2. The result should be negative, with a message similar to "the EHR ehr_ud doesn't exist"
...
...     Postconditions:
...         None
