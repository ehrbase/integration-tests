...
...             - https://github.com/ehrbase/conformance-testing-documentation/blob/main/VERSION_TEST_SUIT.md#versionlatest_version-contains-ehr_status
...
Precondition
    ...
    Set Suite Variable      ${ehr_status_id1}   ${response.json()['ehr_status']['id']['value']}
    ...
    Set Suite Variable      ${ehr_status_id2}   ${response.json()['ehr_status']['id']['value']}
