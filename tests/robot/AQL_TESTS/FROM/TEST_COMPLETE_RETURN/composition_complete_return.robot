...
Test Complete Return Of Composition C
    [Documentation]     Covers: https://github.com/ehrbase/AQL_Test_CASES/blob/main/FROM_TEST_SUIT.MD#test-complete-return
    ...
    ${exclude_paths}    Create List    root['rows'][0][0]['uid']  root['name']['_type']  root['subject']['_type']
    ${diff}     compare json-string with json-file      ${resp_body_actual}     ${expected_result}
