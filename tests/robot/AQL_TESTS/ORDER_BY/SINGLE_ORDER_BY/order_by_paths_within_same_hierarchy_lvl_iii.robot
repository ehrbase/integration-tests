*** Settings ***
Documentation   ORDER BY - SINGLE ORDER BY - ORDER BY PATHS WITHIN SAME HIERARCHY LEVEL III
...             - Covers: https://github.com/ehrbase/AQL_Test_CASES/blob/main/ORDER_BY_SUIT.md#order-by-paths-within-same-hierarchy-level-iii

Resource        ../../../_resources/keywords/aql_keywords.robot
Library     DataDriver
...     file=${PROJECT_ROOT}/tests/robot/_resources/test_data_sets/aql/fields_and_results/order_by/combinations/order_by_paths_within_same_hierarchy_lvl_iii.csv
...     dialect=excel
...
*** Test Cases ***
SELECT ${path} FROM EHR e CONTAINS COMPOSITION c CONTAINS EVENT_CONTEXT ec CONTAINS INTERVAL_EVENT i ORDER BY ${path} ${order}
    #[Tags]      not-ready
...
Execute Query
    ...
    ...     tmp_query=SELECT ${path} FROM EHR e CONTAINS COMPOSITION c CONTAINS EVENT_CONTEXT ec CONTAINS INTERVAL_EVENT i ORDER BY ${path} ${order}
