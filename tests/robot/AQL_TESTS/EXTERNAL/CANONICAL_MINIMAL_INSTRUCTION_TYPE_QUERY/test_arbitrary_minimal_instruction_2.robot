...
...             - https://github.com/ehrbase/openEHR_SDK/blob/develop/client/src/test/java/org/ehrbase/openehr/sdk/client/openehrclient/defaultrestclient/systematic/compositionquery/CanonicalMinimalInstructionTypeQueryIT.java#L99
...             \n*Test testArbitrary2()*
...             - *Case 1* should return *"P65Y5M12D"* -> should pass
...             - *Case 2* should return *"P65Y5M12D"* -> BETWEEN not yet implemented
...             - *Case 3* should return *"P65Y5M12D"* -> BETWEEN not yet implemented
...             - *Case 4* should return *"P65Y5M12D"* -> BETWEEN not yet implemented
Resource        ../../../_resources/keywords/aql_keywords.robot
Library     DataDriver
...     file=${PROJECT_ROOT}/tests/robot/_resources/test_data_sets/aql/fields_and_results/external/canonical_minimal_instruction_type_query/combinations/test_arbitrary_minimal_instruction_2.csv
...     dialect=excel
...
Precondition
    ...
    Commit Composition For AQL      external/minimal_instruction_2.json
