...
...             - https://github.com/ehrbase/AQL_Test_CASES/blob/main/SELECT_TEST_SUIT.md#path-from-entry-to-data-value
...
...     Admin Delete EHR For AQL    ${ehr_id}
...
Execute Query
    ...
    Create File     ${EXPECTED_JSON_DATA_SETS}/select/path_from_entry_to_data_value_tmp.json
    ...     ${data_replaced_vars}
