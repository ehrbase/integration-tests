...
...             - https://github.com/ehrbase/AQL_Test_CASES/blob/main/SELECT_TEST_SUIT.md#drill-down-ehr_status
...
Execute Query
    ...
    ...     ${EXPECTED_JSON_DATA_SETS}/version/expected_drill_down_ehr_status_tmp.json
