...
Update EHR
    ...
    REST.PUT        ${ADMIN_BASEURL}/ehr/${ehr_id}
        ...
        ...             Access Denied because of missing scope: ehrbase:ehr:update ~AND~ Access Denied because of missing scope: ehrbase:admin:access
...
Delete Directory
    ...
    REST.DELETE     ${ADMIN_BASEURL}/ehr/${ehr_id}/directory/${version_uid}
        ...
        String          response body error         Forbidden
        String          response body message
        ...             Access Denied because of missing scope: ehrbase:directory:delete ~AND~ Access Denied because of missing scope: ehrbase:admin:access
...
Delete Composition
    ...
    REST.DELETE     ${ADMIN_BASEURL}/ehr/${ehr_id}/composition/${composition_uid}
        ...
        String          response body error         Forbidden
        String          response body message
        ...             Access Denied because of missing scope: ehrbase:composition:delete ~AND~ Access Denied because of missing scope: ehrbase:admin:access
