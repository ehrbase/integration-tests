...
Create EHR And Check ATNA Logs
    ...
    #with below in body
    #    {
    #    "_source": ["AuditMessage.EventIdentification.EventOutcomeDescription"]
    #    }   ##Sort result to get latest log and Check to be Operation performed successfully
    #Sort result to get latest log and Check EventActionCode to be C
...
Get EHR And Check ATNA Logs
    ...
    #    "_source": ["AuditMessage.EventIdentification.EventOutcomeDescription"]
    #    }   ##Sort result to get latest log and Check to be Operation performed successfully
    #Sort result to get latest log and Check EventActionCode to be R
    retrieve EHR by ehr_id
    Sleep   7s
    Get Logstash Content And Store In Json
