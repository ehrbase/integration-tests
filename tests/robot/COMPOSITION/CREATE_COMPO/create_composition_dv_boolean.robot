...
...             ${\n}Based on:
...             https://github.com/ehrbase/ehrbase/blob/develop/doc/conformance_testing/COMPOSITION_VALIDATION_DATATYPES.md#121-test-case-anything-allowed
...             ${\n}*1.2.1 DV_BOOLEAN Test case anything allowed*
...
*** Variables ***
${composition_file}     Test_dv_boolean.v0__.json
${optFile}              all_types/Test_dv_boolean.v0.opt


*** Test Cases ***
Composition With DV_BOOLEAN.value NULL
    [Tags]      Negative
    [Documentation]     *Test case DV_BOOLEAN:*
    ...     - load json file from CANONICAL_JSON folder
    ...     - update DV_BOOLEAN.value using ${dvBooleanValue} argument value NULL
    ...     - commit composition
...
Composition With DV_BOOLEAN.value True
    [Tags]      Positive
    [Documentation]     *Test case DV_BOOLEAN:*
    ...     - load json file from CANONICAL_JSON folder
...
Composition With DV_BOOLEAN.value False
    [Tags]      Positive
    [Documentation]     *Test case DV_BOOLEAN:*
    ...     - load json file from CANONICAL_JSON folder
