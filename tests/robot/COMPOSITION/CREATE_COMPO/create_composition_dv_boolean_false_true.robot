...
...             ${\n}Based on:
...             https://github.com/ehrbase/ehrbase/blob/develop/doc/conformance_testing/COMPOSITION_VALIDATION_DATATYPES.md#123-test-case-only-false-allowed
...             ${\n}*1.2.3 DV_BOOLEAN Test case only false allowed*
...
*** Variables ***
${composition_file}     Test_dv_boolean_false_true.v0__.json
${optFile}              all_types/Test_dv_boolean_false_true.v0.opt
...
Composition With DV_BOOLEAN.value False - C_BOOLEAN True Invalid - False Valid
    [Tags]      Positive
    [Documentation]     *Test case DV_BOOLEAN:*
    ...     - C_BOOLEAN.true_valid = false
    ...     - C_BOOLEAN.false_valid = true
